...
sourceRouter.route('/')
  .post(asyncHandler(sourceController.create))
sourceRouter.route('/:sourceId')
...
sourceListRouter.route('/:signId/words/:wordId/sources')
  .get(asyncHandler(sourceController.list))
